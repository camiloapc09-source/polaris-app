...
export function EmployeeColillasViewer({ payPeriods, aportes }: Props) {
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: 20 }}>
                  {p.baseSalary > 0 && (
                    <div style={{ textAlign: 'right' }}>
                      <p style={{ fontSize: 11, color: '#A2A2A2', marginBottom: 2 }}>Salario base</p>
                      <p style={{ fontSize: 14, fontWeight: 700, color: '#0F1026' }}>{formatCOP(p.baseSalary)}</p>
                    </div>
                  )}
                  {p.conectividad > 0 && (
                    <div style={{ textAlign: 'right' }}>
                      <p style={{ fontSize: 11, color: '#A2A2A2', marginBottom: 2 }}>Conectividad</p>
                      <p style={{ fontSize: 14, fontWeight: 700, color: '#0F1026' }}>{formatCOP(p.conectividad)}</p>
                    </div>
                  )}
                  <div style={{ textAlign: 'right' }}>
                    <p style={{ fontSize: 11, color: '#A2A2A2', marginBottom: 2 }}>Neto a recibir</p>
